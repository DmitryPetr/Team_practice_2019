...
public class JTest {
    ...
    public void test2() throws Exception{
        ...
        p1.setWeatherInPoint(new WeatherPrameters(8, 19));
        ...
        p2.setWeatherInPoint(new WeatherPrameters(21, 234));
        expected.addLast(p2);
        System.out.println(expected.size());
